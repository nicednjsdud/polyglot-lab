...
function neverExam() {
    ...
    let num = neverFunc(); // upCasting
    let str = neverFunc(); // upCasting
    let bool = neverFunc(); // upCasting
...
function voidExam() {
    ...
    let a = undefined; // void 타입은 undefined 만 할당 가능
...
function anyExam() {
    ...
    let g = undefined;
    let anyVar;
    let num = anyVar; // any 타입은 모든 타입에 할당 가능
    let str = anyVar; // any 타입은 모든 타입에 할당 가능
    let bool = anyVar; // any 타입은 모든 타입에 할당 가능
